...
public class ChatActivity extends Activity implements RoomRequestListener, NotifyListener, ConnectionRequestListener, ChatRequestListener{
	...
	protected Dialog onCreateDialog(int id) {
		...
		Dialog dialog = new Dialog(ChatActivity.this);
		      ...
		      ListView dialog_ListView = (ListView)dialog.findViewById(R.id.player_list);
		      UserListAdapter adapter=new UserListAdapter(ChatActivity.this);
		      adapter.setData(onlineUserList);
		      ...
		      dialog_ListView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					dismissDialog(0);
					sendPrivateChat(onlineUserList.get(position));
				}
			});
	...
	private void sendPrivateChat(User user){
		theClient.sendPrivateChat(user.getName(), inputEditText.getText().toString());
		outputView.append("\n"+Utils.myUserName+": "+inputEditText.getText().toString());
	}
	...
	//	theClient.sendChat(inputEditText.getText().toString());
		...
		showDialog(0);
			...
			Toast.makeText(this, "Currently their is no user", Toast.LENGTH_SHORT).show();
